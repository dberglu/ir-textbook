...
We use generative AI to convert the course description into a [Concept List](./concept-list.md). Each concept is in the form of a short Title Case label with most labels under 32 characters long.
...
6. SEC Filing Requirements
7. Stock Price Volatility
8. AI Fundamentals
9. Data Governance Basics
10. Risk Management Frameworks
11. Change Management Plans
...
1. **Investor Relations Function** (15 dependencies)
2. **Institutional Investors** (9 dependencies)
3. **Machine Learning Basics** (7 dependencies)
4. **Market Communication Strategy** (6 dependencies)
5. **SEC Filing Requirements** (6 dependencies)

---

*Learning graph generated: 2025-11-04*
*Course: AI for Investor Relations Transformation*
*Total concepts: 200 | Categories: 12 | Quality score: Excellent*
